...
If you are interested in contributing to tasks:

1. Set up an account on the SIMS Portal
2. Add your Slack ID and GitHub username to your profile on the portal
3. Join the #2026_africa_ebola-bvd on the SIMS Slack, where requests will be published.
# 2026-africa-ebola-BVD
This repository is used to manage SIMS tasks related to the Red Cross and Red Crescent response to the Ebola BVD outbreak in the Democratic Republic of the Congo (DRC) and neighbouring countries.
